...
e = Event.create({
  ...
  starts_at: DateTime.parse('Fri, 11 Aug 2016 7:00 AM+0700'),
  ends_at: DateTime.parse('Sun, 13 Aug 2016 3:00 PM+0700'),
  venue: dalat,
...
e = Event.create({
  ...
  starts_at: DateTime.parse('Sat, 16 Aug 2016, 8:00 PM+0700'),
  ends_at: DateTime.parse('Sat, 16 Sep 2016, 10:30 PM+0700'),
